...
(function() {
    ...
    window.wasmQrScanner = {
        startCamera: async function(videoElement, dotNetRef) {
            ...
            try {
                ...
                // Start scanning loop
                this.startScanning(videoElement, dotNetRef);
        ...
        startScanning: function(videoElement, dotNetRef) {
